...
@section('content')
   <create-restaurant-page-step-two :step-one-data="{{$stepOneData}}" :step-two-data="{{$stepTwoData}}" :areas="{{$areas}}" :localities="{{$localities}}" :locations="{{$locations}}"></create-restaurant-page-step-two>
   {{-- Add outlet modal --}}
