        ...
        <div class="container-fluid">
            ...
            <div>
                <ul class="navbar-nav align-items-center ms-4">
                    ...
                    <li class="nav-item dropdown ps-2 me-1">
                        <a class="nav-link text-white position-relative" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    @isset($user)
                        ...
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end smaller-dropdown-menu"
                                ...
                                <li><a class="dropdown-item dropdown-no-hover link-red-hover" href="#">Account Info</a></li>
                                <li><a class="dropdown-item dropdown-no-hover link-red-hover" href="#">Change Password</a>
                                </li>
                                <li><a class="dropdown-item dropdown-no-hover link-red-hover" href="#">General Settings</a>
                                </li>
                                <li>
